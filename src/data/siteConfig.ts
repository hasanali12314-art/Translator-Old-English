...
export const BLOG_POSTS = [
  { slug: 'what-is-old-english', title: 'What Is Old English? A Complete Guide to Anglo-Saxon Language', desc: 'Discover the origins, structure, and legacy of Old English.', date: '2024-05-12' },
  { slug: 'middle-english-vs-old-english', title: 'Middle English vs Old English: Key Differences Explained', desc: 'A clear comparison of Old English and Middle English.', date: '2024-05-08' },
  { slug: 'shakespearean-language-guide', title: 'The Complete Guide to Shakespearean Language', desc: 'Learn Early Modern English as used by Shakespeare.', date: '2024-05-04' },
  { slug: 'old-english-in-fantasy-writing', title: 'How to Use Old English in Fantasy Writing', desc: 'A practical guide for fantasy authors.', date: '2024-04-29' },
  { slug: 'history-of-english-language', title: 'The History of the English Language', desc: 'From Anglo-Saxon roots to today.', date: '2024-04-24' },
  { slug: 'old-english-vocabulary', title: '50 Old English Words You Should Know', desc: 'Fascinating Old English words and kennings.', date: '2024-04-19' },
  { slug: 'beowulf-language-analysis', title: 'Beowulf: Language, Style, and Translation Challenges', desc: 'Analysis of Beowulf language and translation.', date: '2024-04-14' },
  { slug: 'old-english-grammar-basics', title: 'Old English Grammar Basics', desc: 'Introduction to Old English grammar.', date: '2024-04-09' },
  { slug: 'old-english-for-game-developers', title: 'Old English for Game Developers', desc: 'Names, spells, and lore for games.', date: '2024-04-03' },
  { slug: 'viking-old-norse-influence', title: 'How Old Norse Shaped the English Language', desc: 'Viking influence on English vocabulary.', date: '2024-03-28' },
];
